    ...
    def forward(self,
        ...
        if self.use_pca or self.joint_rot_mode == 'axisang':
            ...
            if self.use_pca:
                ...
                # print(th_full_hand_pose.shape)
            else:
                th_full_hand_pose = th_hand_pose_coeffs
            self.th_full_hand_pose = th_full_hand_pose
        ...
        v = torch.matmul(self.th_shapedirs, self.th_betas.transpose(0, 1)).permute(2, 0, 1) + self.th_v_template
        r = torch.matmul(self.th_J_regressor[0], v)
        self.wrist_trans = r
